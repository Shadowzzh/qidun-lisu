...
- V1 仅交付官网首页 `/`
- 首页定位为“方案官网首页”，核心表达为企业级私有化 AI 知识智能平台方案

推荐原因：

- 独立项目可以把北京骊甦科技官网和克隆模板彻底隔离
- 首页先行能最快形成对外可看的第一版，同时减少早期范围失控
- 现有 PPT 内容对首页的支撑最强，尤其是 `slide-01`、`slide-04`、`slide-07`、`slide-10`
...
- 内容来源：优先使用 `slide-11`、`slide-13`、`slide-14`、`slide-17`
- 目标：概括未来多页面能力分支
- 承载内容：
  - 算力底座
  - AI 数据平台
...
- 新官网项目已与旧模板工程隔离
- 首页能够明确表达北京骊甦科技的方案定位
- 用户进入页面后能快速理解“是什么、为什么、有什么差异、如何落地”
- 页面阅读体验接近企业官网，而不是 PPT 页面串联
- 内容模型、导航模型、SEO 模型都已为未来多页面扩展预留

## 15. 当前假设

- 归档资料整理工作由其他 AI 负责，不纳入本主线

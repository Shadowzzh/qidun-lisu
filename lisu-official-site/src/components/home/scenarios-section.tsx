  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <p className="text-sm font-medium text-sky-700">SCENARIOS</p>
        <h2 id="scenarios-heading" className="mt-3 text-balance text-3xl font-semibold text-slate-950 md:text-4xl">
          业务场景价值
        </h2>
